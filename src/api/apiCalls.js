...
export const getJobPostingAll = (workModelId, pageNumber, pageSize) => {
    return axios.get(`/api/v1/JobPosting/List?workModelId=${workModelId}&pageNumber=${pageNumber}&pageSize=${pageSize}`);
}
